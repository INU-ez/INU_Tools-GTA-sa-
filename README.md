...
### Генератор Lightmap(временно не работает)
- Генерация кода для скрипта и применение лайтмапов к моделям
- Копирование настроек лайтмапа между объектами
- Настройка V-offset для выравнивания текстур
После генерации, скопировать код в district_example.lua
Ссылка на файл скрипта для Mta лежи в Issues
