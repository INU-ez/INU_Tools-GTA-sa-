...
LANG = {
    ...
    # === Added 2026-05-18 (parity sync with spa.py) ===

    # Animated Map Object — IK/Animation auto/manual mode
    ...
    # DFF export flags — long descriptions
